...
const iconData = [
  ...
  { id: 9, icon: 'https://i.ibb.co/60hZjGww/cost.png', text: 'খরচ', link: 'accounts-dashboard/add-new-expense-entry' },
  { id: 5, icon: 'https://i.ibb.co/fGvLNXKK/collectionreport.png', text: 'কালেকশন রিপোর্ট', link: 'accounts-dashboard/collection-report' },
  { id: 6, icon: 'https://i.ibb.co/Z6cptFwH/studentsfeecollection.png', text: 'ছাত্র-ছাত্রীর কালেকশন', link: 'accounts-dashboard/student-collection' },
