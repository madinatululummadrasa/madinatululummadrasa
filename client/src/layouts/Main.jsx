...
const Main = () => {
  ...
  const hideNavbar = path.startsWith('/dashboard') || path.startsWith('/login') || path.startsWith('/print');
  const hideQuickContact = path.startsWith('/dashboard'); // or add more conditions
